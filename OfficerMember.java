public class OfficerMember extends Subscriber {
  ...
  private String responsibility;//each Junior has an Officer assigned to them  
    ...
    OfficerMember (int mId, String mName, String phone, String sLevel, boolean paid, String responsibility) {
      //because parent class Subscriber has no default constructor,
